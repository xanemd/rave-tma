...
const COMPLIMENTS = [
  ...
  'Ксюша, ты моё солнышко! ☀️',
  'У тебя самая прекрасная улыбка на свете! 😊✨',
  'Ксюня, ты мой самый любимый человек! 💕',
  'Твой голос — лучше любой музыки 🎶',
  'Ксюш, ты делаешь каждый мой день ярче 🌟',
  'Ты невероятно обаятельная! 💫',
  'Ксюня, ты моё главное счастье 🍀',
  'Ксюш, спасибо, что ты у меня есть ❤️',
  'Моя самая родная и любимая девочка 🫂💖',
  'С каждым днём влюбляюсь в тебя всё сильнее 💕',
  'Ты — всё самое лучшее, что со мной случалось ✨',
  'Ксюня, обожаю смотреть видео с тобой! 🍿❤️',
  'С тобой даже самый скучный фильм — шедевр 🎬',
  'Лучший вечер — это вечер рядом с тобой 🌙',
  'Уютики с Ксюшей — 100 из 10 🧸❤️',
  'Главная достопримечательность этого вечера — ты 💖',
  'Самый милый зритель на этом сеансе 🍿✨',
  'Ксюш, обнять тебя — лучшее лекарство от любой усталости 🫂',
  'Идеальный план на вечер: ты, я и видосики 🍕🎥',
  'Готов смотреть с тобой что угодно, хоть 10 часов подряд 💖',
  'Самый лучший кинотеатр — тот, где сидишь ты 🥰',
  ...
  'Отправляю 1000000 виртуальных обнимашек прямо сейчас 🫂💕',
  ...
  'Официально заявляю: Ксюша — самая лучшая девочка в мире 📜❤️',
  'Если бы за милоту давали штрафы, ты бы уже была банкротом 🚓💓',
  'Так, а кто это у нас тут такая красивая смотрит видео? 👀💖',
  'Мой любимый вид спорта — обнимать Ксюшу 🏆🫂',
  'Ксюш, ты вообще законно такая милая? 🤨❤️',
  'Процент счастья в этой комнате только что подскочил на 1000% 📈✨',
  'Ксюня — главный админ моего сердца 👑❤️',
  'Даже алгоритмы YouTube не могут найти ничего прекраснее тебя 🤖💖',
  'Включаем максимальный режим любви и уюта 🚀💕',
  'Ксюня = любовь ❤️',
  'Моя принцесса 👑✨',
  'Самая-самая! 💖',
  'Моя радость 🥰',
...
// Таймер: раз в 10 минут
setInterval(spawnCompliment, 600000);

// Первый вылет через 20 секунд
setTimeout(spawnCompliment, 20000);
